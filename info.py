...
auth_channel = environ.get('AUTH_CHANNEL', '-1002158109531') # give your force subscribe channel id here else leave it blank
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002314383880')
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "  mongodb+srv://shareeftamadaddi1:F0InumvPZwkoHTqz@cluster0.8x5qv.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DATABASE_NAME = environ.get('DATABASE_NAME', "shareeftamadaddi1")
...
OWNER_USERNAME = environ.get('OWNER_USERNAME', 'Darkanetwork') # owner username without @
